...
using _003_Notes_API_Database_01.Services;
using _003_Notes_API_Database_01.Services.Impl;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;

namespace _003_Notes_API_Database_01.Controllers
{
    ...
    public class NotesController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<PaginatedResponse<Note>> GetAll([FromQuery] GetNotesQuery query)
        {
            if(query.Page < 1)
            {
            ...
            PaginatedResponse<Note> response = _notesService.GetAll(query);
        ...
        {
            bool deleted = _notesService.Delete(id);
